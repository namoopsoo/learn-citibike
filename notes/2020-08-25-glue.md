...
authorization: AWS4-HMAC-SHA256 Credential=ASIAUZLUAQ2XCXO3UIME/20200917/us-east-1/execute-api/aws4_request, SignedHeaders=accept;host;x-amz-date, Signature=a7626a275f49ac57a5671bfbc81a3ba92a1b9bf772b682a2cece125ce4438625
accept: application/json


headers = {
    'Accept': "application/json",
    'Authorization': "AWS4-HMAC-SHA256 Credential=ASIAUZLUAQ2XBAGQOIOR/20200918/us-east-1/execute-api/aws4_request, SignedHeaders=accept;host;x-amz-date, Signature=c1f54f3bab31cd958e80293995db1551a4053a6a65abcce1bfd3b204f59a86e6",
...
access_key, secret_key = "ASIAUZLUAQ2XKUIHSX45", "OugGRJXjcXLHYVjDxWIna5rymeIhW98jbDEyU7ML"
region = 'us-east-1'
...
request_dict = {
    ...
    'rider_type': '', 'start_station': '', 'start_time': ''}
#
access_key, secret_key = "ASIAUZLUAQ2XJVLXT3SS", "KPzil7P/blDOoIK3BQ4NkNH9Jf6cLsmYZ1CxH/gP"
region = 'us-east-1'
auth = aws_v4.GET_create_api_gateway_auth(url, request_dict, region, access_key, secret_key)
auth
full_url = f'{url}?{qs}'
